...
CREATE TABLE ResourceTbl (
  ...
  Rate        DECIMAL(10,2)   CONSTRAINT ResRateRequired NOT NULL DEFAULT 1,
...
CREATE TABLE Location (
  ...
  CONSTRAINT LocationFacilityFK    FOREIGN KEY (FacNo) REFERENCES Facility
);
...
CREATE TABLE Employee (
  ...
  CONSTRAINT EmployeeManagerFK      FOREIGN KEY (MgrNo) REFERENCES Employee
);
...
CREATE TABLE EventRequest (
  ...
  CONSTRAINT EventReqCustomerFK    FOREIGN KEY (CusNo) REFERENCES Customer,
  CONSTRAINT EventReqFacilityFK    FOREIGN KEY (FacNo) REFERENCES Facility
);
...
CREATE TABLE EventPlan (
  ...
  CONSTRAINT EventPlanEventRequestFK    FOREIGN KEY (EventNo) REFERENCES EventRequest ON DELETE CASCADE,
  CONSTRAINT EventPlanEmployeeFK        FOREIGN KEY (EmpNo) REFERENCES Employee
);
...
CREATE TABLE EventPlanLine (
  ...
  CONSTRAINT EventPlanLinePlanFK       FOREIGN KEY (PlanNo) REFERENCES EventPlan ON DELETE CASCADE,
  CONSTRAINT EventPlanLocationFK       FOREIGN KEY (LocNo) REFERENCES Location,
  CONSTRAINT EventPlanResourceTblFK    FOREIGN KEY (ResNo) REFERENCES ResourceTbl
);
